  ...
  return (
    <div className="max-w-3xl mx-auto p-6 text-lg leading-relaxed">
      ...
      <p className="mb-4">
        ...
        It was not just more accurate - it was more aware. The model learned to anticipate evasion patterns, making decisions that were interpretable and grounded in structure.
      </p>
      ...
      <p className="mb-4">
        ...
        It is a small step toward models that not only classify but adapt, strategize, and resist deception.
      </p>

      <p className="mt-8 italic text-gray-600 dark:text-gray-400">
        "In a world where fraud evolves, detection must too. Intelligence is not prediction - it is adaptation under pressure."
      </p>
    </div>
  );
}
